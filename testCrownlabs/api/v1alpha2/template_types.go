...
type Environment struct {
	...
	// +optional
	// The name of belonging cluster
	ClusterName string `json:"clusterName,omitempty"`

	// +kubebuilder:validation:Enum=Master;Worker
	// +kubebuilder:validation:Optional
	// +optional
	// The role of cuurent instance playing
	ClusterRole ClusterNodeRole `json:"clusterRole,omitempty"`

	// +kubebuilder:validation:Minimum=0
	// +kubebuilder:validation:Optional
	// +optional
	// Set the sequenctial numbe for each works or master
	// distinguish each instance when replicative name
...
type ControlPlaneRef struct {
	...
	// The configuration of the controlplane machine
	ControlMachine Environment `json:"controlMachine,omitempty"`
}
...
type MachineDeployment struct {
	...
	// The configuration of the worker machine
	ControlMachine Environment `json:"controlMachine"`
}
